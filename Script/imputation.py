...
class ImputeMatrix:
    def __init__(self, contig_file, marker_file, matrix_file, path, gene_cov, rwr_rp, rwr_thres, intra, inter):
        self.thres_mg = gene_cov #threshold to determine whether a marker gene is acceptable
        ...
        self.w_intra = intra #threhold to group contigs together
        self.w_inter = inter #threshold to construct a new group
        self.path = path
